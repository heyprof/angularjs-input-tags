...
var AutoComplete = function () {
  ...
  _createClass(AutoComplete, [{
    ...
    value: function previous() {
      this.path.pop();
      this.currentItem = this.path.length > 0 ? this.path[this.path.length - 1] : this.source;
    }
  }]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js!../node_modules/sass-loader/lib/loader.js!./input-tags.style.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/lib/index.js!../node_modules/sass-loader/lib/loader.js!./input-tags.style.scss");
...
// module
exports.push([module.i, "input-tags .host {\n  width: 100%;\n  outline: none;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none; }\n\ninput-tags .input-group-addon {\n  border-right: 0; }\n\ninput-tags .display {\n  display: block; }\n", ""]);
...
var _inputTags = __webpack_require__(2);
...
var InputTags = function () {
  ...
  _createClass(InputTags, [{
    ...
    value: function addTag(tag) {
      ...
      var valid = tagText && tagText.length >= this.minLength && tagText.length <= this.maxLength && !this.tags.some(function (element) {
...
angular.module('angularjs-input-tags', []).component('inputTags', InputTagsComponent).component('inputTagsAutoComplete', _autoComplete2.default);
...
/***/ })
/******/ ]);
//# sourceMappingURL=angularjs-input-tags.map